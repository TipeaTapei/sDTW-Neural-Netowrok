function perf = myperformance(net,varargin)
% sDTW performance function.
%
% myperformance(net,targets,outputs,errorWeights,...parameters...) calculates a
...
%
% To setup a network to use the same performance measure during training:
%
